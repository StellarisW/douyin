...
func (c *sysClient) GetPublishCount(ctx context.Context, in *GetPublishCountReq, opts ...grpc.CallOption) (*GetPublishCountRes, error) {
	out := new(GetPublishCountRes)
	err := c.cc.Invoke(ctx, "/video.sys.Sys/GetPublishCount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sysClient) GetFavoriteCount(ctx context.Context, in *GetFavoriteCountReq, opts ...grpc.CallOption) (*GetFavoriteCountRes, error) {
	out := new(GetFavoriteCountRes)
	err := c.cc.Invoke(ctx, "/video.sys.Sys/GetFavoriteCount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sysClient) GetTotalFavorited(ctx context.Context, in *GetTotalFavoritedReq, opts ...grpc.CallOption) (*GetTotalFavoritedRes, error) {
	out := new(GetTotalFavoritedRes)
	err := c.cc.Invoke(ctx, "/video.sys.Sys/GetTotalFavorited", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SysServer interface {
	...
	GetPublishCount(context.Context, *GetPublishCountReq) (*GetPublishCountRes, error)
	...
	GetFavoriteCount(context.Context, *GetFavoriteCountReq) (*GetFavoriteCountRes, error)
	...
	GetTotalFavorited(context.Context, *GetTotalFavoritedReq) (*GetTotalFavoritedRes, error)
...
func (UnimplementedSysServer) GetPublishCount(context.Context, *GetPublishCountReq) (*GetPublishCountRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPublishCount not implemented")
}
...
func (UnimplementedSysServer) GetFavoriteCount(context.Context, *GetFavoriteCountReq) (*GetFavoriteCountRes, error) {
...
func (UnimplementedSysServer) GetTotalFavorited(context.Context, *GetTotalFavoritedReq) (*GetTotalFavoritedRes, error) {
...
func _Sys_GetPublishCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPublishCountReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SysServer).GetPublishCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/video.sys.Sys/GetPublishCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SysServer).GetPublishCount(ctx, req.(*GetPublishCountReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Sys_GetFavoriteCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetFavoriteCountReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SysServer).GetFavoriteCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/video.sys.Sys/GetFavoriteCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SysServer).GetFavoriteCount(ctx, req.(*GetFavoriteCountReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Sys_GetTotalFavorited_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTotalFavoritedReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SysServer).GetTotalFavorited(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/video.sys.Sys/GetTotalFavorited",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SysServer).GetTotalFavorited(ctx, req.(*GetTotalFavoritedReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Sys_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetPublishCount",
			Handler:    _Sys_GetPublishCount_Handler,
		},
		{
			MethodName: "Feed",
		...
		},
		{
			...
			Handler:    _Sys_GetFavoriteCount_Handler,
		},
		{
			MethodName: "Comment",
		...
		},
		{
			...
			Handler:    _Sys_GetTotalFavorited_Handler,
		},
	},
