...
func (c *sysClient) ManageComment(ctx context.Context, in *ManageCommentReq, opts ...grpc.CallOption) (*ManageCommentRes, error) {
	out := new(ManageCommentRes)
	err := c.cc.Invoke(ctx, "/video.sys.Sys/ManageComment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SysServer interface {
	...
	ManageComment(context.Context, *ManageCommentReq) (*ManageCommentRes, error)
...
func (UnimplementedSysServer) ManageComment(context.Context, *ManageCommentReq) (*ManageCommentRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ManageComment not implemented")
}
...
func _Sys_ManageComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ManageCommentReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SysServer).ManageComment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/video.sys.Sys/ManageComment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SysServer).ManageComment(ctx, req.(*ManageCommentReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Sys_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Sys_ManageComment_Handler,
		},
		{
